...
public class ControllerViewPainelCaixa implements Initializable{
	...
	public void start(Stage primaryStage) {
		try {
			AnchorPane pane = (AnchorPane) FXMLLoader.load(getClass().getResource("/resources/view/painel/PainelCaixa.fxml"));
